  ...
  useEffect(() => {
    ...
    function getTransitionIcon(hour24: number) {
      if (hour24 === 6) {
        ...
        return `<div class="transition-icon"><svg viewBox="0 0 24 24" fill="none" stroke="#C0C0C0" strokeWidth="2"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"/></svg></div>`
      }
      return null
    }
    ...
    function createCityDial(city: any, isLocal: boolean) {
      ...
      const deleteButton = isLocal
        ? ""
        : `<button class="delete-button" data-city="${city.name}-${city.timezone}" title="Remove city"><svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polyline points="3 6 5 6 21 6"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><line x1="10" y1="11" x2="10" y2="17"/><line x1="14" y1="11" x2="14" y2="17"/></svg></button>`
    ...
    <>
      <div className="container">
        <div className="header-bar">
          <h1 className="font-serif tracking-normal font-semibold text-xl leading-6 flex items-center gap-2">
            <img src="/logo.png" alt="Remote Timezone Logo" className="w-8 h-8 object-contain" />
            Remote Timezone
          </h1>
